package com.myservice.resource.web.controller;
...
import com.myservice.resource.web.dto.FooDto;
...
public class FooController {
    ...
    @CrossOrigin(origins = {"http://78.47.114.254:8089", "http://http://78.47.114.254:80"})
    @GetMapping(value = "/{id}")
